...
// attempting to create my own PUT endpoint to edit steps 
router.put('/:scheme_id/:step_id', checkSchemeId, validateStep, (req, res, next) => {
  // const updatedStep = req.body 
  const { scheme_id, step_id } = req.params

  Schemes.updateStep(scheme_id, step_id)
    .then(updatedStep => {
